    ...
    <div class="wd-product wd-hover-quick product-grid-item product type-product{{ $outOfStock ? ' outofstock' : ' instock' }} has-post-thumbnail{{ $hasSale ? ' sale' : '' }}"
        ...
        <div class="wd-product-wrapper product-wrapper">
            <div class="wd-product-thumb product-element-top wd-quick-shop">
                ...
                @endif
                <div class="wd-buttons wd-pos-center">
            ...
            <div class="product-element-bottom">
                ...
                <span class="price">
                    @if($hasSale)
                        <del aria-hidden="true"><span class="woocommerce-Price-amount amount"><bdi>{{ \App\Support\Money::formatShort($product->selling_price) }}</bdi></span></del>
                        <ins aria-hidden="true"><span class="woocommerce-Price-amount amount"><bdi>{{ \App\Support\Money::formatShort($displayPrice) }}</bdi></span></ins>
                    @else
                        <span class="woocommerce-Price-amount amount"><bdi>{{ \App\Support\Money::formatShort($displayPrice) }}</bdi></span>
                    @endif
                </span>
