@php
    $newsletterTitle = \App\Models\SiteSetting::get('home_newsletter_title', 'Get 10% Off Your First Order');
    $newsletterSubtitle = \App\Models\SiteSetting::get('home_newsletter_subtitle', '');
@endphp
<div class="wp-block-wd-container wd-dir-col wd-align wd-066a5243 wd-newsletter-section">
    ...
    <h2 class="wp-block-wd-title title wd-29c12066">{{ $newsletterTitle }}</h2>

    @if ($newsletterSubtitle)
        <p class="wp-block-wd-paragraph wd-a5b20c44">{{ $newsletterSubtitle }}</p>
    @endif
