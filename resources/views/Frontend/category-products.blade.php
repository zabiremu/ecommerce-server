...
(function () {
    ...
    let catSlug    = catParams.get('cat') || catParams.get('slug') || '';
    let priceMin   = 0;
    ...
    window.renderCatPage = function () {
        try {
            ...
            console.error('Failed to render category product listing:', err);
    ...
    function init() {
        try {
            ...
            console.error('Failed to resolve category label:', err);
        }
        renderCatPage();
    }
