...
@push('styles')
    ...
    <style id='wd-woo-page-lost-password-inline-css' type='text/css'>
        ...
        /*# sourceURL=merchandise/wp-content/themes/woodmart/css/parts/woo-page-lost-password.css */
    </style>
    ...
    <script type="text/javascript" id="zxcvbn-async-js-extra">
        /* <![CDATA[ */
        var _zxcvbnSettings = {
            "src": "merchandise/wp-includes/js/zxcvbn.min.js"
        };
        //# sourceURL=zxcvbn-async-js-extra
        /* ]]> */
    </script>
    <script type="text/javascript" src="merchandise/wp-includes/js/dist/hooks.min.js" id="wp-hooks-js"></script>
    <script type="text/javascript" src="merchandise/wp-includes/js/dist/i18n.min.js" id="wp-i18n-js"></script>
    ...
    <script type="text/javascript" src="merchandise/wp-content/plugins/woocommerce/assets/js/frontend/account-i18n.min.js"
        id="wc-account-i18n-js" defer="defer" data-wp-strategy="defer"></script>
    <script type="text/javascript" src="merchandise/wp-content/plugins/woocommerce/assets/js/frontend/lost-password.min.js"
        id="wc-lost-password-js" defer="defer" data-wp-strategy="defer"></script>
        ...
        <main id="main-content" class="wd-content-layout content-layout-wrapper container wd-builder-on" role="main">
            <div class="wd-content-area site-content">
                <div class="woocommerce entry-content">
                    <style id="wd-style-blocks-1034-inline-css" data-type="wd-style-blocks-1034">
                        #wd-a74f6102 {
                            margin-top: -40px;
                            margin-bottom: 40px;
                        }
                    ...
                    <link rel="stylesheet" id="wd-el-page-title-builder-css"
                        ...
                        media="all" />
                    <div id="wd-a74f6102" class="wd-page-title-el wd-a74f6102">
                    ...
                    <div id="wd-76a95b59" class="wp-block-wd-container wd-dir-col wd-align-is-lg-center">
                        <div id="wd-9d73aec3" class="wd-el-my-account-lost-password wd-9d73aec3 wd-custom-width">
                            ...
                            <form method="post" class="woocommerce-ResetPassword lost_reset_password">
                                ...
                                <p class="woocommerce-form-row woocommerce-form-row--first form-row form-row-first">
                                    <label for="user_login">Username or email&nbsp;<span class="required"
                                ...
                                <input type="hidden" id="woocommerce-lost-password-nonce"
                                    name="woocommerce-lost-password-nonce" value="705cfaf43e" /><input type="hidden"
                                    name="_wp_http_referer" value="/merchandise/my-account/lost-password/" />
                            </form>
                        </div>
                    </div>
                </div>
