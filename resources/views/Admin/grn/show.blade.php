                ...
                <table class="wp-list-table" style="border: 0; box-shadow: none;">
                    ...
                    <tfoot>
                        <tr>
                            ...
                            <th class="text-right">{{ \App\Support\Money::format($goodsReceivedNote->items->sum('total')) }}</th>
                        </tr>
                    </tfoot>
                </table>
            </div>
        ...
        <div class="wp-panel">
            ...
            <div class="wp-panel-body">
                ...
                <div class="wc-summary-total">
                    ...
                    <span class="val">{{ \App\Support\Money::format($goodsReceivedNote->items->sum('total')) }}</span>
                </div>
            </div>
        </div>
